...
public class _HelloStub extends org.omg.CORBA.portable.ObjectImpl implements HelloApp.Hello
{
  ...
  public int[] sum (int[] a, int[] b)
  {
            ...
            try {
                ...
                HelloApp.HelloPackage.arraymioHelper.write ($out, a);
                HelloApp.HelloPackage.arraymioHelper.write ($out, b);
                $in = _invoke ($out);
                int $result[] = HelloApp.HelloPackage.arraymioHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
