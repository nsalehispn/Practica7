 ...
 implements HelloApp.HelloOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         int a[] = HelloApp.HelloPackage.arraymioHelper.read (in);
         int b[] = HelloApp.HelloPackage.arraymioHelper.read (in);
         int $result[] = null;
         $result = this.sum (a, b);
         out = $rh.createReply();
         HelloApp.HelloPackage.arraymioHelper.write (out, $result);
         break;
       }
